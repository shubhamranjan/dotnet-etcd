...
namespace dotnet_etcd
{
    ...
    public partial class EtcdClient
    {
        ...
        public Task Watch(WatchRequest request, Action<WatchResponse> method, Metadata headers = null,
        ...
        /// <param name="deadline">An optional deadline for the call. The call will be cancelled if deadline is hit.</param>
        /// <param name="cancellationToken">An optional token for canceling the call.</param>
        public Task Watch(WatchRequest request, Action<WatchResponse>[] methods,
        ...
        /// <param name="deadline">An optional deadline for the call. The call will be cancelled if deadline is hit.</param>
        /// <param name="cancellationToken">An optional token for canceling the call.</param>
        public Task Watch(WatchRequest[] requests, Action<WatchResponse> method,
            Metadata headers = null, DateTime? deadline = null,
        ...
        /// <param name="deadline">An optional deadline for the call. The call will be cancelled if deadline is hit.</param>
        /// <param name="cancellationToken">An optional token for canceling the call.</param>
        public Task Watch(WatchRequest request, Action<WatchEvent[]> method, Metadata headers = null,
            DateTime? deadline = null,
        ...
        /// <param name="deadline">An optional deadline for the call. The call will be cancelled if deadline is hit.</param>
        /// <param name="cancellationToken">An optional token for canceling the call.</param>
        public Task Watch(WatchRequest request, Action<WatchEvent[]>[] methods, Metadata headers = null,
            DateTime? deadline = null,
        ...
        /// <param name="deadline">An optional deadline for the call. The call will be cancelled if deadline is hit.</param>
        /// <param name="cancellationToken">An optional token for canceling the call.</param>
        public Task Watch(WatchRequest[] requests, Action<WatchEvent[]> method, Metadata headers = null,
        DateTime? deadline = null,
        ...
        /// <param name="deadline">An optional deadline for the call. The call will be cancelled if deadline is hit.</param>
        /// <param name="cancellationToken">An optional token for canceling the call.</param>
        public Task WatchRange(WatchRequest request, Action<WatchResponse> method,
            Metadata headers = null, DateTime? deadline = null,
            CancellationToken cancellationToken = default) => WatchRange(new WatchRequest[1]{ request }, new Action<WatchResponse>[1] { method }, headers, deadline, cancellationToken);
        ...
        /// <param name="deadline">An optional deadline for the call. The call will be cancelled if deadline is hit.</param>
        /// <param name="cancellationToken">An optional token for canceling the call.</param>
        public Task WatchRange(WatchRequest request, Action<WatchResponse>[] methods,
            Metadata headers = null, DateTime? deadline = null,
            CancellationToken cancellationToken = default) => WatchRange(new WatchRequest[1] { request }, methods, headers, deadline, cancellationToken);
        ...
        /// <param name="deadline">An optional deadline for the call. The call will be cancelled if deadline is hit.</param>
        /// <param name="cancellationToken">An optional token for canceling the call.</param>
        public Task WatchRange(WatchRequest[] requests, Action<WatchResponse> method,
            Metadata headers = null, DateTime? deadline = null,
            CancellationToken cancellationToken = default) => WatchRange(requests, new Action<WatchResponse>[1] { method }, headers, deadline, cancellationToken);
        ...
        /// <param name="deadline">An optional deadline for the call. The call will be cancelled if deadline is hit.</param>
        /// <param name="cancellationToken">An optional token for canceling the call.</param>
        public Task WatchRange(WatchRequest request, Action<WatchEvent[]> method,
            Metadata headers = null, DateTime? deadline = null,
        ...
        /// <param name="deadline">An optional deadline for the call. The call will be cancelled if deadline is hit.</param>
        /// <param name="cancellationToken">An optional token for canceling the call.</param>
        public  Task WatchRange(WatchRequest request, Action<WatchEvent[]>[] methods,
            Metadata headers = null, DateTime? deadline = null,
            CancellationToken cancellationToken = default) => Watch(new WatchRequest[1] { request }, methods, headers, deadline, cancellationToken);
        ...
        /// <param name="deadline">An optional deadline for the call. The call will be cancelled if deadline is hit.</param>
        /// <param name="cancellationToken">An optional token for canceling the call.</param>
        public Task WatchRange(WatchRequest[] requests, Action<WatchEvent[]> method,
            Metadata headers = null, DateTime? deadline = null,
