...
public partial class EtcdClient
{
    ...
    public LockResponse Lock(string name, Metadata headers = null, DateTime? deadline = null,
        CancellationToken cancellationToken = default) => Lock(new LockRequest { Name = ByteString.CopyFromUtf8(name) },
    ...
    public LockResponse Lock(LockRequest request, Metadata headers = null, DateTime? deadline = null,
        ...
        connection.LockClient.Lock(request, headers, deadline, cancellationToken));
    ...
    public async Task<LockResponse> LockAsync(string name, Metadata headers = null,
        ...
        await LockAsync(new LockRequest { Name = ByteString.CopyFromUtf8(name) }, headers, deadline, cancellationToken)
    ...
    public async Task<LockResponse> LockAsync(LockRequest request, Metadata headers = null,
        DateTime? deadline = null, CancellationToken cancellationToken = default) => await CallEtcdAsync(
        async connection => await connection.LockClient
    ...
    public UnlockResponse Unlock(string key, Metadata headers = null, DateTime? deadline = null,
        ...
        Unlock(new UnlockRequest { Key = ByteString.CopyFromUtf8(key) }, headers, deadline, cancellationToken);
    ...
    public UnlockResponse Unlock(UnlockRequest request, Metadata headers = null,
        DateTime? deadline = null, CancellationToken cancellationToken = default) => CallEtcd(connection => connection
        .LockClient
    ...
    public async Task<UnlockResponse> UnlockAsync(string key, Metadata headers = null,
        DateTime? deadline = null, CancellationToken cancellationToken = default) =>
        await UnlockAsync(new UnlockRequest { Key = ByteString.CopyFromUtf8(key) }, headers, deadline,
