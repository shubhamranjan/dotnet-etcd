...
public partial class EtcdClient
{
    ...
    public RangeResponse Get(string key, Metadata headers = null, DateTime? deadline = null,
        CancellationToken cancellationToken = default) => Get(new RangeRequest { Key = ByteString.CopyFromUtf8(key) },
    ...
    public async Task<RangeResponse> GetAsync(string key, Metadata headers = null,
        ...
        await GetAsync(new RangeRequest { Key = ByteString.CopyFromUtf8(key) }, headers, deadline, cancellationToken)
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return Get(
            new RangeRequest
            {
                Key = GetStringByteForRangeRequests(prefixKey), RangeEnd = ByteString.CopyFromUtf8(rangeEnd)
            }, headers, deadline, cancellationToken);
    }
    ...
    {
        string rangeEnd = GetRangeEnd(prefixKey);
        return RangeRespondToDictionary(Get(
            new RangeRequest
            {
                Key = GetStringByteForRangeRequests(prefixKey), RangeEnd = ByteString.CopyFromUtf8(rangeEnd)
            }, headers, deadline, cancellationToken));
    ...
    {
        string rangeEnd = GetRangeEnd(prefixKey);
        return RangeRespondToDictionary(
            await GetAsync(
                new RangeRequest
                {
                    Key = GetStringByteForRangeRequests(prefixKey), RangeEnd = ByteString.CopyFromUtf8(rangeEnd)
    ...
    public PutResponse Put(PutRequest request, Metadata headers = null, DateTime? deadline = null,
        CancellationToken cancellationToken = default) => CallEtcd(connection =>
        connection.KVClient.Put(request, headers, deadline, cancellationToken));
    ...
    public PutResponse Put(string key, string val, Metadata headers = null, DateTime? deadline = null,
        CancellationToken cancellationToken = default) =>
        Put(new PutRequest { Key = ByteString.CopyFromUtf8(key), Value = ByteString.CopyFromUtf8(val) }, headers,
    ...
    public async Task<PutResponse> PutAsync(string key, string val, Metadata headers = null,
        DateTime? deadline = null,
        CancellationToken cancellationToken = default) =>
        await PutAsync(new PutRequest { Key = ByteString.CopyFromUtf8(key), Value = ByteString.CopyFromUtf8(val) },
            headers, deadline, cancellationToken).ConfigureAwait(false);
    ...
    public DeleteRangeResponse Delete(string key, Metadata headers = null, DateTime? deadline = null,
        CancellationToken cancellationToken = default) => Delete(
    ...
    public async Task<DeleteRangeResponse> DeleteAsync(string key, Metadata headers = null,
        DateTime? deadline = null,
        CancellationToken cancellationToken = default) =>
        await DeleteAsync(new DeleteRangeRequest { Key = ByteString.CopyFromUtf8(key) }, headers, deadline,
    ...
    public TxnResponse Transaction(TxnRequest request, Metadata headers = null, DateTime? deadline = null,
        CancellationToken cancellationToken = default) => CallEtcd(connection =>
        connection.KVClient.Txn(request, headers, deadline, cancellationToken));
