...
namespace dotnet_etcd.Tests.Integration
{
    ...
    public class WatchRangeIntegrationTests
    {
        ...
        {
            // Arrange
            string key1 = $"{_testPrefix}key1";
            string key2 = $"{_testPrefix}key2";
            string key3 = $"{_testPrefix}key3";
            ...
            // Assert
            bool allEventsReceived = eventCountReached.Wait(TimeSpan.FromSeconds(5));
            ...
            {
                receivedKeys.Add(evt.Kv.Key.ToStringUtf8());
            }
        ...
        {
            // Arrange
            string keyInRange = $"{_testPrefix}in-range";
            string keyOutsideRange = $"outside-{_testPrefix}";
        ...
        {
            // Arrange
            string prefix = $"prefix-{Guid.NewGuid()}/";
            string key1 = $"{prefix}key1";
            string key2 = $"{prefix}key2";
            string keyOutsidePrefix = $"outside-{prefix}key";
